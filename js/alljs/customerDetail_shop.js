$(function(){
    ...
    $('.pic').click(function(){
        window.location.href = '/static/app/html/customerData_shop.html?type=1';
    })
    ...
    var comment = {
        ...
        getmesData: function() {  // 信息
            $.ajax({
                type:'GET',
                url: global + "/v1.0/merchantData/merchantCustomerDataDetailList",
                data:this.params,
